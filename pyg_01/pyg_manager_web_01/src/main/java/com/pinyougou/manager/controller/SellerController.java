...
public class SellerController {
	...
	@RequestMapping("/setStatus/{status}/{sellerId}")
	public Result  setStatus(@PathVariable("status") String status, @PathVariable("sellerId")String sellerId){

		try {
			sellerService.setStatus(status, sellerId);
