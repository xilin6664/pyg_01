//服务层
app.service('shopGoodsService',function($http){
	...
	//商品上下架管理
    this.setMarketableStatus=function(marketableStatus,selectIds){
        return $http.get('../goods/setMarketableStatus/'+marketableStatus+'/'+selectIds);
    }
});
